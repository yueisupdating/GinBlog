...
func InitRouter() {
	...
	routerV1 := engine.Group("api/v1")
	{
		...
		routerV1.GET("admin/user", v1.GetUser)
		routerV1.GET("admin/users", v1.GetUsers)
		routerV1.GET("admin/category", v1.GetCate)
		routerV1.GET("admin/categorys", v1.GetCates)
		routerV1.GET("admin/articles", v1.GetArticles) // 所有文章列表查询
